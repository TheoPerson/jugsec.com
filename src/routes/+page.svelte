...
<div class="min-h-screen bg-base text-text-primary font-sans overflow-x-hidden selection:bg-accent/30">
	...
	>
		<div class="container mx-auto px-6 md:px-12 flex justify-between items-center max-w-7xl">
			...
			<div class="hidden md:flex items-center gap-[1.5rem]">
				...
				{:else}
					...
					<a href="/register" class="px-5 py-2.5 rounded-lg bg-accent text-[#06060a] font-bold text-sm whitespace-nowrap shadow-[0_0_20px_rgba(0,212,255,0.3)] hover:shadow-[0_0_30px_rgba(0,212,255,0.5)] transition-all">
						Get Started
					</a>
				{/if}
			</div>
		...
		<!-- Mobile Nav -->
		{#if isMobileMenuOpen}
			<div class="absolute top-full left-0 w-full bg-base/95 backdrop-blur-xl border-b border-border-subtle p-6 flex flex-col gap-[1.5rem] md:hidden shadow-2xl">
				...
				{:else}
					...
					<a href="/register" class="w-full text-center px-5 py-3 rounded-lg bg-accent text-[#06060a] font-bold text-lg shadow-[0_0_20px_rgba(0,212,255,0.3)]">Get Started</a>
				{/if}
			</div>
		{/if}
	</header>
	...
	<main>
		...
		<section class="relative pt-32 pb-20 md:pt-48 md:pb-32 flex flex-col items-center justify-center min-h-[90vh] text-center overflow-hidden">
			...
			<div class="container relative z-10 px-6 mx-auto max-w-4xl">
				...
				<h1 class="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-6">
					...
					<span class="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] to-[#00ff88]">True Power</span>
				</h1>
				...
				<div class="flex flex-col sm:flex-row items-center justify-center gap-[1.5rem] mb-[4rem]">
					<a href="/register" class="w-full sm:w-auto px-10 py-5 whitespace-nowrap rounded-xl bg-accent text-[#06060a] font-bold text-lg shadow-[0_0_30px_rgba(0,212,255,0.4)] hover:shadow-[0_0_50px_rgba(0,212,255,0.6)] hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
						Book Your Session
						<ArrowRight class="w-5 h-5" />
					</a>
					<a href="#how-it-works" class="w-full sm:w-auto px-10 py-5 whitespace-nowrap rounded-xl bg-surface-1 border border-border-default hover:border-border-strong text-lg font-semibold hover:bg-surface-2 transition-all flex items-center justify-center">
						See How It Works
					</a>
				</div>
				
				<div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-[3rem] border-t border-border-subtle max-w-3xl mx-auto">
		...
		<section id="how-it-works" class="py-20 md:py-32">
			<div class="container mx-auto px-6 max-w-5xl">
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
					...
					<div class="relative flex flex-col items-center text-center">
						<div class="w-24 h-24 rounded-2xl bg-accent flex items-center justify-center text-3xl font-black text-[#06060a] mb-6 z-10 shadow-[0_0_30px_rgba(0,212,255,0.4)]">3</div>
			...
			<div class="container mx-auto px-6 max-w-5xl">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
					...
					<div class="relative bg-surface-1 border-2 border-accent rounded-3xl p-8 md:p-12 flex flex-col shadow-[0_0_40px_rgba(0,212,255,0.15)]">
						<div class="absolute -top-5 left-1/2 -translate-x-1/2 bg-accent text-[#06060a] px-4 py-1.5 rounded-full text-sm font-black uppercase tracking-wide">Most Popular</div>
						...
						<a href="/register?plan=pro" class="w-full py-4 rounded-xl bg-accent text-[#06060a] text-center font-bold shadow-[0_0_20px_rgba(0,212,255,0.4)] hover:shadow-[0_0_30px_rgba(0,212,255,0.6)] transition-all">Upgrade to Pro</a>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="py-24 md:py-40 relative overflow-hidden border-y border-border-subtle">
			...
			<div class="container mx-auto px-6 relative z-10 text-center">
				...
				<a href="/register" class="inline-flex items-center gap-2 px-10 py-5 rounded-xl bg-accent text-[#06060a] font-bold text-xl shadow-[0_0_40px_rgba(0,212,255,0.4)] hover:shadow-[0_0_60px_rgba(0,212,255,0.6)] hover:-translate-y-1 transition-all">
	...
	<footer class="bg-base pt-20 pb-10 border-t border-border-subtle">
		<div class="container mx-auto px-6 max-w-7xl">
			<div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-[4rem]">
			...
			<div class="border-t border-border-subtle pt-8 flex flex-col md:flex-row justify-between items-center gap-[1.5rem]">
